...
# Total number of sent, received and lost downlinks to devices
python3 plotData.py Sent\ downlinks\ for\ devices\ \(sum\) s -I -o $out_directory/messagesSentDownlinksForDevicesCountScattered.pdf -l sent\ 100-2 sent\ 100-4 sent\ 100-8 sent\ 100-16 -i ${stochastic_100_2}messageSentGatewaysLoRaDevicesCount100_2.csv ${stochastic_100_4}messageSentGatewaysLoRaDevicesCount100_4.csv ${stochastic_100_8}messageSentGatewaysLoRaDevicesCount100_8.csv ${stochastic_100_16}messageSentGatewaysLoRaDevicesCount100_16.csv &
...
python3 plotData.py Received\ downlinks\ for\ devices\ \(sum\) l -I -o $out_directory/messagesReceivedDownlinksForDevicesCountLine.pdf -l received\ 100-2 received\ 100-4 received\ 100-8 received\ 100-16 -i ${stochastic_100_2}messageReceivedDevicesCount100_2.csv ${stochastic_100_4}messageReceivedDevicesCount100_4.csv ${stochastic_100_8}messageReceivedDevicesCount100_8.csv ${stochastic_100_16}messageReceivedDevicesCount100_16.csv &

python3 plotData.py Lost\ downlinks\ for\ devices\ \(sum\) s -I -o $out_directory/messagesLostDownlinksForDevicesCountScattered.pdf -l lost\ 100-2 lost\ 100-4 lost\ 100-8 lost\ 100-16 -i ${stochastic_100_2}messageLostDevicesCount100_2.csv ${stochastic_100_4}messageLostDevicesCount100_4.csv ${stochastic_100_8}messageLostDevicesCount100_8.csv ${stochastic_100_16}messageLostDevicesCount100_16.csv &
python3 plotData.py Lost\ downlinks\ for\ devices\ \(sum\) l -I -o $out_directory/messagesLostDownlinksForDevicesCountLine.pdf -l lost\ 100-2 lost\ 100-4 lost\ 100-8 lost\ 100-16 -i ${stochastic_100_2}messageLostDevicesCount100_2.csv ${stochastic_100_4}messageLostDevicesCount100_4.csv ${stochastic_100_8}messageLostDevicesCount100_8.csv ${stochastic_100_16}messageLostDevicesCount100_16.csv &
...
# Total number of sent, received and lost downlinks to gateways
python3 plotData.py Sent\ downlinks\ for\ gateways\ \(sum\) s -I -o $out_directory/messagesSentDownlinksForGatewaysCountScattered.pdf -l sent\ 100-2 sent\ 100-4 sent\ 100-8 sent\ 100-16 -i ${stochastic_100_2}messageSentGatewaysLoRaGatewaysCount100_2.csv ${stochastic_100_4}messageSentGatewaysLoRaGatewaysCount100_4.csv ${stochastic_100_8}messageSentGatewaysLoRaGatewaysCount100_8.csv ${stochastic_100_16}messageSentGatewaysLoRaGatewaysCount100_16.csv &
python3 plotData.py Sent\ downlinks\ for\ gateways\ \(sum\) l -I -o $out_directory/messagesSentDownlinksForGatewaysCountLine.pdf -l sent\ 100-2 sent\ 100-4 sent\ 100-8 sent\ 100-16 -i ${stochastic_100_2}messageSentGatewaysLoRaGatewaysCount100_2.csv ${stochastic_100_4}messageSentGatewaysLoRaGatewaysCount100_4.csv ${stochastic_100_8}messageSentGatewaysLoRaGatewaysCount100_8.csv ${stochastic_100_16}messageSentGatewaysLoRaGatewaysCount100_16.csv &
...
python3 plotData.py Received\ downlinks\ for\ gateways\ \(sum\) l -I -o $out_directory/messagesReceivedDownlinksForGatewaysCountLine.pdf -l received\ 100-2 received\ 100-4 received\ 100-8 received\ 100-16 -i ${stochastic_100_2}messageReceivedGatewaysLoRaGatewaysCount100_2.csv ${stochastic_100_4}messageReceivedGatewaysLoRaGatewaysCount100_4.csv ${stochastic_100_8}messageReceivedGatewaysLoRaGatewaysCount100_8.csv ${stochastic_100_16}messageReceivedGatewaysLoRaGatewaysCount100_16.csv &
